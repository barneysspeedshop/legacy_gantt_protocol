...
void main() {
  group('CRDTEngine Robustness', () {
    ...
    test('should handle "start" and "end" keys (as well as variants)', () {
      final op = Operation(
        type: 'INSERT_TASK',
        data: {'id': 't1', 'start': '2025-12-26T20:00:00.000Z', 'end': '2025-12-27T20:00:00.000Z', 'name': 'Test Task'},
    ...
    test('should preserve duration if only start is updated (or vice versa) via existing fallback', () {
      // First create a task
      final op1 = Operation(
        type: 'INSERT_TASK',
        data: {'id': 't3', 'start_date': '2025-12-26T10:00:00.000Z', 'end_date': '2025-12-26T12:00:00.000Z'},
      ...
      expect(result.first.end, equals(DateTime.utc(2025, 12, 26, 12))); // Preserved from op1
    });
  });
}
